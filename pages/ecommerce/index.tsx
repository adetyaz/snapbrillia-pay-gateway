...
export default function Home() {
  return (
    <>
      {/* container */}
      <div className="bg-gray-100 flex h-screen items-center justify-center gap-4 flex-wrap">
        {/* product card */}
        ...
        <div className="bg-white duration-300 flex flex-col max-w-xs rounded-xl shadow-lg space-y-4 transform w-full hover:-translate-y-2">
          ...
          <div className="flex flex-col px-4 space-y-1">
            <div className="flex flex-col -space-y-0.5">
              ...
              <p className="text-gray-500 text-xs">Female hills</p>
            </div>
          ...
          <div className="flex flex-row items-center justify-between pb-4 px-4">
            ...
            <button className="bg-blue-400 font-medium inline-flex items-center px-4 px-2 rounded-md shadow-md text-white transition hover:bg-blue-500">
              <FaShoppingCart className="mr-2" />
              <NextLink href="https://pay.preprod.nmkr.io/?p=31e9636ad4804d0b8be1455708a823f3&n=0458cc6e136c4244aa87427e40702617">
                Pay with Cardano
              </NextLink>
            </button>
          </div>
        ...
        <div className="bg-white duration-300 flex flex-col max-w-xs rounded-xl shadow-lg space-y-4 transform w-full hover:-translate-y-2">
          ...
          <div className="flex flex-col px-4 space-y-1">
            <div className="flex flex-col -space-y-0.5">
              ...
              <p className="text-gray-500 text-xs">Cool Sneakers</p>
            </div>
          ...
          <div className="flex flex-row items-center justify-between pb-4 px-4">
            ...
            <button className="bg-blue-400 font-medium inline-flex items-center px-4 px-2 rounded-md shadow-md text-white transition hover:bg-blue-500">
              <FaShoppingCart className="mr-2" />
              <NextLink href="https://pay.preprod.nmkr.io/?p=31e9636ad4804d0b8be1455708a823f3&n=8e1e1590831840538a08d6b014c70e8d">
                Pay with Cardano
              </NextLink>
            </button>
          </div>
